...
/**
 * Health check for the asd, health is displayed on the Marathon GUI.
 */
public class asdHealthCheck implements HealthReporter {

    //for logging.
    private static final Logger LOG = LoggerFactory.getLogger(asd.class);

    public asdHealthCheck() {
    }
    ...
    public HealthResult healthCheck() {
        ...
        // In this scenario, the asd does not depend on any external components. It will always return HealthResult.RESULT_HEALTHY.
