 ...
 */
public class asdResultValidationProcessor extends ContentResultValidationProcessor<asdResult, asdTestInput, asdTestExpectation> {

    public asdResultValidationProcessor(WorkerServices workerServices) {
        super(workerServices.getDataStore(), workerServices.getCodec(), asdResult.class, asdResultAccessors::getTextData, SettingsProvider.defaultProvider.getSetting(SettingNames.expectedFolder));
    }
     ...
     */
    @Override
    protected boolean processWorkerResult(TestItem<asdTestInput, asdTestExpectation> testItem, TaskMessage message, asdResult workerResult) throws Exception {
