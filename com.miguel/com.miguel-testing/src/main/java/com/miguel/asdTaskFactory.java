 ...
 */
public class asdTaskFactory extends FileInputWorkerTaskFactory<asdTask, asdTestInput, asdTestExpectation> {
    public asdTaskFactory(TestConfiguration configuration) throws Exception {
        super(configuration);
    }
     ...
     */
    @Override
    protected asdTask createTask(TestItem<asdTestInput, asdTestExpectation> testItem, ReferencedData sourceData) {
        asdTask task = testItem.getInputData().getTask();
