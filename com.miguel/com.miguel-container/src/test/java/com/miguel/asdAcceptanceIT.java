...
/**
 * Integration test for asd, running the testing framework.
 */
public class asdAcceptanceIT extends UseAsTestName_TestBase
{
    ...
    {
        testControllerProvider = new asdTestControllerProvider();
